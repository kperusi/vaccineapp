...
import { globalContext } from "@/app/utils/context/globalContext";
...
const {vaccines,setVaccines,fetchVaccines}=useContext(globalContext)
  ...
  useEffect(() => {
    async function getVaccines() {
      ...
      setUser(JSON.parse(localStorage.getItem("vax-login-user")));
    }
  ...
  async function handleAddVaccine(e) {
    ...
    const res = await fetch("/api/admin/create-vaccine", {
      method: "POST",
