...
console.log(id)
  try {
    ...
    const stock = await sql`
      SELECT * FROM inventory WHERE vaccine_type_id = ${r.vaccine_type_id} 
   ...
   VALUES(${inventory_id},${r.facility_id},${r.quantity_requested},'vaccine allocated by admin')
    ...
    await sql`
      ...
      VALUES (${r.facility_id}, ${r.vaccine_type_id}, ${inventoryItem.batch_number},${inventoryItem.manufacturer_date},${inventoryItem.expiry_date},${r.quantity_requested},${inventoryItem.storage_condition})
